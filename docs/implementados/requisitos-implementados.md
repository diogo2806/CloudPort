...
2. Incorporar Navio e Navio Siderúrgico no primeiro corte.
3. Incorporar Yard ao mesmo runtime.
...
4. Transformar `PosicaoPatioYardCliente` em porta e criar `PosicaoPatioLocalAdapter`.
...
13. Excluir do runtime configurações standalone duplicadas de segurança, erros, OpenAPI e conversores genéricos.
...
2. Atualizar `README.md` da raiz e do runtime.
...
5. Reserva em posição real livre.
6. Autenticação do Control Room e integração ao portal.
7. Scheduler baseado em dados reais.
8. Cadastro canônico de Navio.
9. Incorporação estrutural dos sete módulos no runtime.
10. Portas locais para Navio, Yard e Autenticação.
11. Parent Maven e build único.
12. Sete schemas e históricos Flyway independentes.
13. Segurança, CORS, Jackson, erros, logs, métricas, tracing e agendamento centralizados.
14. Controles de escrita, jobs e consumidores para coexistência.
15. Testes ArchUnit de ciclos e repositories entre módulos.
16. Definição de ownership e rollback Flyway.
17. Preservação dos deployments e credenciais legadas até o aceite operacional.
