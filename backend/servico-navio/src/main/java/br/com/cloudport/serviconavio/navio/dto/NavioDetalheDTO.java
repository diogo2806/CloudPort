...
public class NavioDetalheDTO {
    ...
    public NavioDetalheDTO(Long identificador, String nome, String codigoImo, String paisBandeira,
            String empresaArmadora, Integer capacidadeTeu, BigDecimal loaMetros,
            BigDecimal caladoMaximoMetros, String callSign) {
        this(identificador, nome, codigoImo, paisBandeira, empresaArmadora, capacidadeTeu,
                loaMetros, caladoMaximoMetros, callSign, null);
    }
    public NavioDetalheDTO(Long identificador, String nome, String codigoImo, String paisBandeira,
            String empresaArmadora, Integer capacidadeTeu, BigDecimal loaMetros,
            BigDecimal caladoMaximoMetros, String callSign, Long versao) {
        this.identificador = identificador; this.nome = nome; this.codigoImo = codigoImo;
        this.paisBandeira = paisBandeira; this.empresaArmadora = empresaArmadora;
        this.capacidadeTeu = capacidadeTeu; this.loaMetros = loaMetros;
        this.caladoMaximoMetros = caladoMaximoMetros; this.callSign = callSign; this.versao = versao;
    }
