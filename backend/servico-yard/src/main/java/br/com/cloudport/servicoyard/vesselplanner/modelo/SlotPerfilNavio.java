...
public class SlotPerfilNavio {
    ...
    @Column(name = "tipo_slot", nullable = false, length = 30)
    ...
    public PerfilGeometriaNavio getPerfil() { return perfil; }
    public void setPerfil(PerfilGeometriaNavio perfil) { this.perfil = perfil; }
