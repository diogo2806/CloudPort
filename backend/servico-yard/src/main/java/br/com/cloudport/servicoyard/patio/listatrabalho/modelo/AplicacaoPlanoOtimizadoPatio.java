...
@Entity
@Table(
        name = "aplicacao_plano_otimizado_patio",
        uniqueConstraints = @UniqueConstraint(
                name = "uk_aplicacao_plano_otimizado_patio",
                columnNames = {"plano_id", "visita_navio_id"}
        )
)
public class AplicacaoPlanoOtimizadoPatio {
    ...
    private StatusAplicacaoPlanoOtimizadoPatio status;
    ...
    public StatusAplicacaoPlanoOtimizadoPatio getStatus() {
        return status;
    }

    public void setStatus(StatusAplicacaoPlanoOtimizadoPatio status) {
        this.status = status;
    }
