...
public class VisitaTremRequisicaoDto {
    ...
    public Long getTremMestreId() { return tremMestreId; }
    public void setTremMestreId(Long tremMestreId) { this.tremMestreId = tremMestreId; }
    public String getIdentificadorTrem() { return identificadorTrem; }
    public void setIdentificadorTrem(String identificadorTrem) { this.identificadorTrem = ValidacaoEntradaUtil.limparTexto(identificadorTrem); }
    public String getOperadoraFerroviaria() { return operadoraFerroviaria; }
    public void setOperadoraFerroviaria(String operadoraFerroviaria) { this.operadoraFerroviaria = ValidacaoEntradaUtil.limparTexto(operadoraFerroviaria); }
    ...
    public List<OperacaoConteinerVisitaRequisicaoDto> getListaDescarga() { return listaDescarga; }
    public void setListaDescarga(List<OperacaoConteinerVisitaRequisicaoDto> listaDescarga) { this.listaDescarga = listaDescarga != null ? new ArrayList<>(listaDescarga) : new ArrayList<>(); }
    public List<OperacaoConteinerVisitaRequisicaoDto> getListaCarga() { return listaCarga; }
    public void setListaCarga(List<OperacaoConteinerVisitaRequisicaoDto> listaCarga) { this.listaCarga = listaCarga != null ? new ArrayList<>(listaCarga) : new ArrayList<>(); }
    public List<VagaoVisitaRequisicaoDto> getListaVagoes() { return listaVagoes; }
    public void setListaVagoes(List<VagaoVisitaRequisicaoDto> listaVagoes) { this.listaVagoes = listaVagoes != null ? new ArrayList<>(listaVagoes) : new ArrayList<>(); }
}
