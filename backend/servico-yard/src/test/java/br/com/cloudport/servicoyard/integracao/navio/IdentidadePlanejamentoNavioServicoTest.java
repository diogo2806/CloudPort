...
class IdentidadePlanejamentoNavioServicoTest {
    ...
    @Test
    void deveResolverNavioEViagemDaVisitaCanonica() {
        ContextoPlanejamentoNavio contexto = servico.resolverVisita(
                20L,
                10L,
                "imo1234567",
                "out-002");
    ...
    @Test
    void deveRecusarVisitaDeOutroNavio() {
    ...
    @Test
    void deveRecusarPlanoComVersaoCanonicaDesatualizada() {
    ...
    @Test
    void deveRecusarViagemForaDaVisita() {
        assertThrows(IllegalArgumentException.class, () -> servico.resolverVisita(
                20L,
                10L,
                "IMO1234567",
