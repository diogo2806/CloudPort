...
@Component
@ConditionalOnProperty(name = "cloudport.modulo.navio.integracao", havingValue = "local")
public class ConsultaPlanejamentoNavioLocalAdapter implements ConsultaPlanejamentoNavioPorta {
    ...
    public ConsultaPlanejamentoNavioLocalAdapter(NavioServico navioServico, VisitaNavioServico visitaNavioServico) {
    ...
    @Override public NavioPlanejamento buscarNavioPorId(Long identificador) {
        ...
        return new NavioPlanejamento(dto.getIdentificador(), dto.getNome(), dto.getCodigoImo(), dto.getCallSign(), dto.getVersao());
    }
    ...
    @Override public VisitaPlanejamento buscarVisitaPorId(Long identificador) {
        ...
        return new VisitaPlanejamento(visita.getId(), visita.getNavio().getNavioCadastroId(), visita.getCodigoVisita(),
