...
class QuayBerthCraneValidacaoYardServicoTest {
    ...
    @Mock
    private ConsultaWorkQueueYardPorta consultaWorkQueueYard;

    private QuayBerthCraneValidacaoYardServico servico;

    @BeforeEach
    void configurar() {
        servico = new QuayBerthCraneValidacaoYardServico(
                visitaNavioServico,
                itemRepositorio,
                planoRepositorio,
                consultaWorkQueueYard);
    }

    @Test
    void deveRejeitarPlanoAntesDeRemoverPersistenciaVigente() {
        ...
        when(consultaWorkQueueYard.listarParaValidacaoPlano(1L)).thenReturn(List.of(fila));
