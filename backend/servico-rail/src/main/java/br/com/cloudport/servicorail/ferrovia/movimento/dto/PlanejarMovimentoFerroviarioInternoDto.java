...
public class PlanejarMovimentoFerroviarioInternoDto {
    ...
    public List<String> getRotas() { return rotas; }
    public void setRotas(List<String> rotas) { this.rotas = rotas; }
    ...
    public void setTrechos(List<String> trechos) { this.trechos = trechos; }
    public List<String> getSwitches() { return switches; }
    public void setSwitches(List<String> switches) { this.switches = switches; }
}
