...
public class ConsultaPlanejamentoNavioHttpCliente implements ConsultaPlanejamentoNavioPorta {
    ...
    public ConsultaPlanejamentoNavioHttpCliente(
    ...
    public NavioPlanejamento buscarNavioPorId(Long identificador) {
        ...
        NavioResposta resposta = restTemplate.getForObject(
                navioBaseUrl + "/navios/{identificador}",
                NavioResposta.class,
                identificador);
    ...
    public NavioPlanejamento buscarNavioPorImo(String codigoImo) {
        ...
        if (!StringUtils.hasText(imo)) {
            throw new IllegalArgumentException("O código IMO deve ser informado.");
        }
        ResponseEntity<NavioResumoResposta[]> resposta = restTemplate.getForEntity(
                navioBaseUrl + "/navios",
                NavioResumoResposta[].class);
        NavioResumoResposta resumo = Arrays.stream(
                        resposta.getBody() == null ? new NavioResumoResposta[0] : resposta.getBody())
    ...
    public VisitaPlanejamento buscarVisitaPorId(Long identificador) {
        ...
        VisitaResposta resposta = restTemplate.getForObject(
                visitaBaseUrl + "/visitas-navio/{identificador}/planejamento",
                VisitaResposta.class,
                identificador);
    ...
    public static class NavioResposta {
        ...
        public NavioPlanejamento paraDominio() {
            return new NavioPlanejamento(identificador, nome, codigoImo, callSign, versao);
        }
