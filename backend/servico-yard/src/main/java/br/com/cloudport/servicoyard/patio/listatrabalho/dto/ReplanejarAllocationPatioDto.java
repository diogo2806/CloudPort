...
public class ReplanejarAllocationPatioDto {
    ...
    public void setMotivo(String motivo) { this.motivo = ValidacaoEntradaUtil.limparTexto(motivo); }
    public String getUsuario() { return usuario; }
    public void setUsuario(String usuario) { this.usuario = ValidacaoEntradaUtil.limparTexto(usuario); }
    public String getOrigemAcao() { return origemAcao; }
    public void setOrigemAcao(String origemAcao) { this.origemAcao = ValidacaoEntradaUtil.limparTexto(origemAcao); }
    public String getCorrelationId() { return correlationId; }
    public void setCorrelationId(String correlationId) { this.correlationId = ValidacaoEntradaUtil.limparTexto(correlationId); }
}