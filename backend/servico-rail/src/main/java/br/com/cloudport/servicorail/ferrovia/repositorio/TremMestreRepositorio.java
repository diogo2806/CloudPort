...
public interface TremMestreRepositorio extends JpaRepository<TremMestre, Long> {
    ...
    @EntityGraph(attributePaths = "composicaoPadrao") Optional<TremMestre> findComposicaoById(Long id);
    @EntityGraph(attributePaths = "composicaoPadrao") List<TremMestre> findAllByOrderByAtivoDescOperadoraFerroviariaAscIdentificadorAsc();
}
