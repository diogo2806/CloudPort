...
public class ModoEscritaSiderurgicoFiltro extends OncePerRequestFilter {
    ...
    private static final byte[] RESPOSTA = ("{\"codigo\":\"RUNTIME_LEGADO_SOMENTE_LEITURA\","
            + "\"mensagem\":\"O deployment legado siderurgico esta em modo somente leitura durante o corte.\","
